...
<section class="form-container">
      ...
      <input type="tel" name="number" required pattern="[0-9]{10}" placeholder="Enter your number" class="box" title="Please enter a valid 10-digit number">
      <input type="password" name="pass" required minlength="7" maxlength="20" placeholder="Enter your password" class="box">
